 ...
 letter-spacing: 1px; font-size: 16px; -ms-word-break: break-all; word-break: break-word; -webkit-hyphens: auto; -moz-hyphens: auto; hyphens: auto;" bgcolor="rgb(234, 236, 237)">
    <div style="margin: 0 auto; background-color: #fff; max-width: 600px; border-radius: 4px;">
        ...
        <div class="email-body" style="padding: 10px 20px 10px 20px;">
            ...
            <h4  style="color: #21225f;font-weight:500;">The line <b style="color: #f1582b;">{{$data->name}}</b> has been created by  <b style="color: #f1582b;">{{$data->actorName}}</b></h4> 
            ...
            <span style="color: #21225f;display:block;font-weight:notmal;">PO Target Date : {{date('m-d-Y',strtotime($data->so_target_date))}} </span>
            <span style="color: #21225f;display:block;font-weight:notmal;">Delivery Date : {{date('m-d-Y',strtotime($data->delivery_target_date))}} </span>
