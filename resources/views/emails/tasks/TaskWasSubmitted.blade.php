 ...
 letter-spacing: 1px; font-size: 16px; -ms-word-break: break-all; word-break: break-word; -webkit-hyphens: auto; -moz-hyphens: auto; hyphens: auto;" bgcolor="rgb(234, 236, 237)">
    <div style="margin: 0 auto; background-color: #fff; max-width: 600px; border-radius: 4px;">
        ...
        <div class="email-body" style="padding: 10px 20px 10px 20px;">
            <h4 style="color: #21225f; font-weight:500;">Hey {{$data->creator_id['displayName']}},</h4>
            <h4  style="color: #21225f;font-weight:500;"><b style="color: #f1582b;">{{$data->assignee_id['displayName']}} ({{$data->assignee_id['email']}}) </b> has submitted the task assigned by  you</h4> 

            <span style="color: #21225f;display:block;font-weight:notmal;">Task Subject: {{$data->title}}</span>
